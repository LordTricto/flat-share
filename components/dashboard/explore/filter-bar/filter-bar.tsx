...
function FilterBar(props: Props) {
	...
	return (
		<>
			<div
				className={
					"-moz-h-fit-available -webkit-h-fit-available -ms-h-fit-available fixed right-0 z-20 h-full min-w-[280px] overflow-y-auto duration-150 lg:relative lg:-translate-x-0 lg:transition-none " +
					`${width < 1024 ? (props.isActive ? " -translate-x-0" : "translate-x-full") : ""} `
				}
			>
				<div className="absolute left-0 top-0 flex h-full w-full flex-col gap-6 overflow-y-auto border-l border-grey-quat bg-white px-5 py-6">
					...
					<Accordion
						...
						onToggle={() => setFilterOpened((_opened) => (_opened === FilterOptions.BUDGET ? FilterOptions.NONE : FilterOptions.BUDGET))}
					>
						<div className="flex w-full flex-col items-center">
							<div className="flex w-full items-center justify-between">
								...
								<span className={`text-xs ${tempBudgetMaxValue === 5000000 ? "text-black-tertiary" : "text-black-secondary"}`}>
					...
					<Accordion
						...
						onToggle={() => setFilterOpened((_opened) => (_opened === FilterOptions.AGE ? FilterOptions.NONE : FilterOptions.AGE))}
					>
						<div className="flex w-full flex-col items-center">
							<div className="flex w-full items-center justify-between">
					...
					<Accordion
						...
						onToggle={() => setFilterOpened((_opened) => (_opened === FilterOptions.GENDER ? FilterOptions.NONE : FilterOptions.GENDER))}
					>
