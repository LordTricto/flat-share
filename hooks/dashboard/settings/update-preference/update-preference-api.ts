...
export enum UpdatePreferenceSignal {
	UPDATE_PREFERENCE = "user.update-preference",
}

export const updatePreferenceApi = async (data: UpdatePreferenceForm): Promise<UpdatePreferenceFormResponse> => {
	const signal = getAbortControllerSignal(UpdatePreferenceSignal.UPDATE_PREFERENCE);
