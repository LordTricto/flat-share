...
export default function Home() {
	return (
		<main className="flex min-h-screen w-full flex-col items-center justify-between">
			<section className="flex justify-between items-center min-h-screen w-full max-w-7xl mx-auto px-4 2xs:px-8 lg:px-16">
				<div className="flex flex-col justify-start items-start h-full w-full max-w-xl gap-12">
					<div className="flex flex-col justify-start items-start gap-6">
						...
						<p className="text-xl text-black-tertiary">
				...
				<div className="flex justify-end items-center gap-4 h-full w-max">
					<Image className="mt-10" src={heroImgTwo} alt="black woman smiling" width={190} height={562} priority />
			...
			<section className="relative min-h-screen w-full">
				...
				<div className="w-full bg-sky-blue">
					<div className="flex flex-col justify-center items-center gap-14 pt-14 pb-16 max-w-7xl mx-auto px-4 2xs:px-8 lg:px-16">
						<h1 className="text-4xl text-black font-black">How FlatShare Works</h1>
						...
						<div className="flex flex-row justify-between items-center gap-8 w-full">
							<div className="flex flex-col gap-5 p-6 bg-white rounded-2xl">
								...
								<div className="flex flex-col gap-4">
									<h3 className="text-black font-semibold">Easy to Use</h3>
				...
				<div className="flex flex-row justify-between items-center w-full py-16 max-w-7xl mx-auto px-4 2xs:px-8 lg:px-16">
					...
					<div className="flex flex-col gap-10 w-full max-w-lg">
						<div className="flex flex-col gap-4">
							<h3 className="text-3xl text-black font-black">We are here to serve you</h3>
							<p className="text-black-tertiary">
						...
						<div className="flex flex-col justify-start items-start gap-10">
							...
							<div className="flex flex-row justify-start items-start gap-6">
								...
								<div className="flex flex-col justify-start items-start gap-4">
									<h6 className="font-semibold">Best Structure</h6>
									<p className="text-sm text-black-tertiary">
							...
							<div className="flex flex-row justify-start items-start gap-6">
								...
								<div className="flex flex-col justify-start items-start gap-4">
									<h6 className="font-semibold">100% Reliable</h6>
									<p className="text-sm text-black-tertiary">
				...
				<div className="flex flex-row justify-between items-center w-full py-16 bg-purple">
					<div className="flex flex-col justify-center items-center gap-8 w-full max-w-7xl mx-auto px-4 2xs:px-8 lg:px-16 ">
						<h3 className="text-3xl text-white font-black">Subscribe to Our Newsletter</h3>
						<p className="text-white w-full max-w-[600px]">
